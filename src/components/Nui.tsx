...
import { firebaseType, partsType } from '../types/apiType';

import { FC } from 'react';
import { partsSvgArray } from '../libs/partsArray';

type Props = {
  firebaseData: firebaseType;
  nuiPartsApi: partsType[];
};

const Nui: FC<Props> = ({ firebaseData, nuiPartsApi }) => {
    ...
    <Flex gap="16px">
      ...
      >
        {nuiPartsApi.map((item: partsType, i) => (
          ...
          >
            {firebaseArray[i].svg.map((svgIndex: number, i2) => (
              <Box
                display="flex"
                justifyContent="space-between"
                margin="auto"
                ...
                <Box
                  ...
                  sx={{
                    ...
                    ...(item.color !== undefined && {
                      '.colorChange': {
                        fill: item.color[firebaseArray[i].color],
                      },
                    }),
                  }}
                />
